...
st.markdown("As you can see teams at the top consistently performed well in each of the last two seasons, while there are some teams who performed at the bottom of the table consistently." \
...
st.markdown("While all the teams are available in Figure 2 for educational purposes I will focus on the teams listed above. As you can see when comparing Brentford and Wolves to" \
...
st.markdown("Takeaway: From this, we can conclude that Home Field Advantage does not appear to be one of the factors that seperates elite teams such as Man City and Liverpool from "
...
st.markdown("From figure 3, we notice that Man City has 53 total cards in 2023-2024 and 59 total cards in 2024-2025. Liverpool had 70 cards in " \
...
st.markdown("Takeaway: Discipline appears to be correlated with sustained success as elite clubs seem to avoid picking up cards as frequently as bottom-tier clubs. " \
...
st.markdown("Across both seasons, a consistent pattern emerges. Liverpool and Man City both have significantly higher shot volumes than the Wolves and Brentford. There is a large gap "
...
st.markdown("Takeaway: A clear differentiator between elite clubs like Liverpool and Man City and struggling clubs such as the Wolves and Brentford is offensive pressure. Top teams generate" \
...
st.markdown("This analysis was examining which factors seperate elite clubs such as Liverpool and Man City from bottom-tier clubs such as the Wolves and Brentford. Through exploratory analysis," \
" we were able to establish a couple of hypotheses. ")

st.markdown("First, we looked at home-field advantage to see if elite clubs took advantage of their home turf more than bottom-tier clubs. However, after examining the difference in advantage " \
...
st.markdown("What was most interesting, however, was the offensive gap. The strongest teams generated higher volumes of shots, and were able to apply more attacking pressure throughout the season." \
...
st.markdown("Taking these results together, evidence suggests that sustained offensive aggression along with discpline is strongly associated with long-term success. This analysis" \
